import { User, Bell, Clock, Settings, LogOut, ChevronRight, Sparkles, QrCode, Award, Coffee, Zap } from 'lucide-react';

const SKILLS = [
   { name: 'Barista', level: 'Pro', icon: <Coffee className="w-4 h-4" /> },
   { name: 'Ofen', level: 'Master', icon: <Zap className="w-4 h-4" /> },
   { name: 'Service', level: 'Advanced', icon: <User className="w-4 h-4" /> },
];

export function ProfileView({ userPoints }) {
  return (
    <div className="pb-24">
           ...
           <div className="relative z-10 flex flex-col h-full justify-between">
              <div className="flex justify-between items-start">
                 <div className="flex items-center space-x-4">
                    ...
                    <div>
                       <h2 className="text-xl font-bold font-serif leading-none mb-1">Max Mustermann</h2>
                       <div className="text-white/60 text-xs font-medium uppercase tracking-wider">Personal-ID: 839210</div>
                    </div>
                 </div>
              ...
              <div className="flex justify-between items-end">
                 <div>
                    <div className="text-[10px] uppercase tracking-widest text-white/50 mb-1">Filiale</div>
                    <div className="font-bold text-lg">Köln-Nippes</div>
                 </div>
                 <div className="text-right">
                    ...
                    <div className="text-[10px] font-mono text-white/60 mt-1">{userPoints || 980} PKT</div>
                 </div>
              </div>
           </div>
        </div>
